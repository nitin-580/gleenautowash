...
const localServices: Service[] = [
    {
        ...
        description: [
          "Quick exterior wax application",
          "Enhances shine and depth of paint",
          "Protects against minor scratches and dust",
        ...
        isBestSeller: false,
        rating: 4.4,
        imageUrl: "/assets/services/image copy 9.png",
      },
      // {
      //   id: "12",
      //   name: "Teflon Coating",
      //   description: [
      //     "Durable Teflon-based paint protection",
      //     "Reduces paint damage from scratches",
      //     "High-gloss finish that lasts weeks",
      ...
      //   isBestSeller: true,
      //   rating: 4.6,
      //   imageUrl: "/assets/services/image copy 10.png",
      // },
      {
        id: "13",
        name: "Ceramic Coating (Lite)",
        description: [
          "Nano-ceramic liquid coating",
          "Protects paint from UV rays, dirt, and oxidation",
          "Hydrophobic and self-cleaning properties",
          "Lasts 3–6 months with shine retention",
        ],
        basePrice: 2999,
        duration: 90,
        category: "premium",
      ...
      },
      {
        ...
        description: [
          "Water-repellent glass protection",
          "Improves visibility during rain",
          "Easy bug & dirt removal",
          "Lasts up to 1 month",
        ],
        basePrice: 399,
        duration: 20,
      ...
      },
      {
        ...
        description: [
          ...
          "Resistant to UV, water spots, and scratches",
        ...
        isBestSeller: true,
        rating: 4.9,
        imageUrl: "/assets/services/image copy 11.png",
      }
]
